...
class BasicRegressionModel(AbstractRegressionModel):
    """
    Basic regression model using a random forest.

    Inherits from AbstractRegressionModel and implements basic functionality
    ...
    def _init_model(self, params: Params):
        """
        Initializes the RandomForestRegressor with the provided parameters.
